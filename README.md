...
# Особенности
На данный момент, ввод полей не проверяется на корректность, то есть, если вы введёте букву там, где надо цифру или введёте дату не по формату, то программа без объяснения причин свалится. 
